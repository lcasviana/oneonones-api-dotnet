...
namespace Oneonones.Persistence.Base
{
    public abstract class SqlBase
    {
        ...
        protected async Task<IList<T>> Query<T>(string query, object parameters, int? timeout = null)
        {
        ...
        protected async Task<T> QueryFirst<T>(string query, object parameters, int? timeout = null)
        {
            using var connection = SqlConnection;
        ...
        protected async Task<int> Execute(string query, object parameters, int? timeout = null)
        {
            using var connection = SqlConnection;
